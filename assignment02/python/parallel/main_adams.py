    ...
    try:
        ...
        for n_threads in threads_to_test:
            ...
            plot_stability_region_basic(
                ...
                f"output_a/stability_basic_{n_threads}threads.png",
            ...
            plot_stability_region_by_thread(
                ...
                n_threads,
                f"output_a/stability_by_thread_{n_threads}threads.png",
                xl=-3.0, xr=1.0, yb=-2.0, yt=2.0)
        ...
        plt.tight_layout()
        plt.savefig(f'output_a/performance_comparison{method}.png', dpi=300)
        plt.show()
