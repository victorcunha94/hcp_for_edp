...
\begin{figure}[H]
\centering
\subfigure[Euler implícito com 4 threads \label{fig:euler_python}]{
\includegraphics[width=.4\textwidth]{Figuras/PYTHON/stability_by_thread_4threads.png}
} % end subfigure
\quad % dá um espaço entre as duas figuras.
\subfigure[Euler implícito com 16 threads. \label{fig:euler_leveque}]{
...
\begin{figure}[H]
\centering
\subfigure[Euler implícito com 1 threads \label{fig:euler_python}]{
\includegraphics[width=.4\textwidth]{Figuras/PYTHON/PC/stability_basic_1threads.png}
} % end subfigure
\quad % dá um espaço entre as duas figuras.
\subfigure[Euler implícito com 16 threads. \label{fig:euler_leveque}]{
\includegraphics[width=.4\textwidth]{Figuras/PYTHON/PC/stability_by_thread_16threads.png}
} % end subfigure
\caption{Distribuição de pontos por thraeds}
\label{fig:euler_implicito}
\end{figure}
